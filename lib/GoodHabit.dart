...
class GoodHabitPage extends StatefulWidget {
  const GoodHabitPage({Key? key}) : super(key: key);

  @override
  _GoodHabitPageState createState() => _GoodHabitPageState();
}

class _GoodHabitPageState extends State<GoodHabitPage> {
  TimeOfDay? time = null;
  DateTime? date = null;
  String remainderTime = "9:00 AM";
